...
@Repository
@Slf4j
public class DishIngredientFilteringRepository {
    @PersistenceContext
    private EntityManager entityManager;

    private static String BASE_QUERY = "select di from DishIngredient di where 1=1 ";

    public List<DishIngredient> filter(Filters filters) {
        ...
        return entityManager.createQuery(res,DishIngredient.class).getResultList();
