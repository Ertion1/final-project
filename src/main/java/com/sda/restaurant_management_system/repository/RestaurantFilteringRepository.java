...
@Repository
@Slf4j
public class RestaurantFilteringRepository {
    @PersistenceContext
    private EntityManager entityManager;
    private static String BASE_QUERY = "select r from Restaurant r where 1=1 ";
    public List<Restaurant> filter(Filters filters){
      ...
      return entityManager.createQuery(res, Restaurant.class).getResultList();
    }
